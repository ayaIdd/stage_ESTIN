...
const images = [
    { src: './assets/ldc.png', title: 'Leisure & Discovery Club ', type:"The Leisure & Discovery Club (LDC) at the École Supérieure en Sciences et Technologies de l'Informatique et du Numérique (ESTIN) is dedicated to enriching student life by balancing academic pursuits with engaging and enjoyable activities. With a philosophy of Human First, Student Second, LDC prioritizes the well-being and holistic development of its members." },
  { src: './assets/img8.jpg', title: 'Excursions ',  description:"Planned trips and outings to explore new places, offering students the chance to discover and learn outside the classroom environment.LDC aims to add a fun and dynamic element to school life, making the academic journey at ESTIN more enjoyable and memorable."},
  { src: './assets/img9.jpg', title: 'Ramadan Ftour:', description:"Organized community gatherings to break the fast during Ramadan, fostering a sense of unity and cultural celebration among students."},
  { src: './assets/img10.jpg', title: 'Sports Events', description:"Encouraged physical fitness and team spirit through various sports activities and tournaments, promoting a healthy and active lifestyle." },
]
